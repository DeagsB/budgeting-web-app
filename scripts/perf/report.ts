...
const sb = load('scrub', before), sa = load('scrub', after)
add('Chart scrub long frames (Chrome 4x)', med(sb, 'summary.rafGapsCount'), med(sa, 'summary.rafGapsCount'), '', '0')
add('Chart scrub long tasks ms (Chrome 4x)', med(sb, 'summary.longTasksTotalMs'), med(sa, 'summary.longTasksTotalMs'))
